...
import org.apache.hadoop.fs.filesystem.GlusterFileSystem;
import org.apache.hadoop.fs.filesystem.GlusterVolume;
...
public class GlusterFs extends FilterFs{
    ...
    protected static final Logger log= LoggerFactory.getLogger(GlusterFs.class);
    
    
    public GlusterFs(Configuration conf) throws IOException, URISyntaxException{
        super(new GlusterVol(conf));
    }

    public GlusterFs(final URI theUri, final Configuration conf) throws IOException, URISyntaxException{
        this(conf);
    }
