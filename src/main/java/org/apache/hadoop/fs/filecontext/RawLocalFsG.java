...
public class RawLocalFsG extends DelegateToFileSystem {
    ...
    RawLocalFsG(final URI theUri, final FileSystem fs, final Configuration conf, boolean authorityRequired)
    ...
    /**
     * This constructor has the signature needed by {@link AbstractFileSystem#createFileSystem(URI, Configuration)}.
     *
     ...
     * or there is an error acessing the symlink.
     */
    ...
    /**
     * Return a FileStatus representing the given path. If the path refers to a symlink return a FileStatus representing
     * the link rather than the object the link refers to.
     */
    @Override
